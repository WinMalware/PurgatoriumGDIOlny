...
INT WINAPI wWinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPWSTR lpCmdline, int nCmdShow)
{
	...
	{
		if (MessageBoxW(NULL, L"You are about to run a GDI Only.\n\n\
...
The creator is not responsible for any data loss or damage made to your computer.\n\n\
Do you still wanna execute this GDI Only?", L"PurgatoriumGDIOlny.exe - FINAL WARNING", MB_ICONWARNING | MB_YESNO) != IDYES) return 1;
